const canvasPaneHeaderTheme = {
  slots: {
    root: 'relative flex h-7 shrink-0 items-center gap-1 border-b border-border bg-panel-secondary px-1.5 text-muted after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-transparent',
