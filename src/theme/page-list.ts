const pageListTheme = {
  slots: {
    ...
    header: 'flex shrink-0 items-center justify-between px-3 py-2',
    title: 'text-[11px] font-semibold text-surface',
    add: 'flex size-5 cursor-pointer items-center justify-center rounded border-none bg-transparent text-muted transition-colors hover:bg-hover hover:text-surface focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-panel-focus',
    ...
    icon: 'size-3.5 shrink-0 text-muted',
    renameInput:
    ...
    item: 'flex w-full cursor-pointer items-center gap-1.5 rounded border-none px-2 py-1.5 text-left text-[11px] outline-none transition-colors focus-visible:ring-1 focus-visible:ring-panel-focus',
    label: 'truncate'
  },
  variants: {
    active: {
      true: { item: 'bg-panel-selected-muted text-surface' },
